...
AnimationComponent::AnimationComponent(sf::Sprite& sprite, sf::Texture& textures_sheet)
	:sprite(sprite), textureSheet(textures_sheet), lastAnimation(NULL), priorityAnimation(NULL)
{
...
const bool& AnimationComponent::play(const std::string key, const float & dt, const bool priority)
{
	...
	if (this->priorityAnimation) //If there is a priority animaiton
	{
