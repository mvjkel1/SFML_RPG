...
void MainMenuState::initGui()
{
	...
	{
		throw "ERROR::MAINMENUSTATE::FAILED_TO_LOAD_BACKROUND_TEXTURE";
	}
	...
	this->btnBackground.setFillColor(sf::Color(20, 20, 20, 220));
	
	//Buttons
	this->buttons["GAME_STATE"] = new gui::Button(
		gui::p2pX(15.6f, vm), gui::p2pY(23.5f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
		&this->font, "New Game", gui::calcCharSize(vm),
		sf::Color(250, 70, 70, 200), sf::Color(150, 150, 150, 250), sf::Color(20, 20, 20, 50),
		sf::Color(70, 70, 70, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0)
	);

	this->buttons["SETTINGS_STATE"] = new gui::Button(
		gui::p2pX(15.6f, vm), gui::p2pY(30.5f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
	...
	this->buttons["EDITOR_STATE"] = new gui::Button(
		gui::p2pX(15.6f, vm), gui::p2pY(37.5f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
	...
	this->buttons["EXIT_STATE"] = new gui::Button(
		gui::p2pX(15.6f, vm), gui::p2pY(48.5f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
