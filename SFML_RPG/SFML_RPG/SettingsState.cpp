...
void SettingsState::initGui()
{
	...
	this->buttons["BACK"] = new gui::Button(
		gui::p2pX(44.3f, vm), gui::p2pY(74.f, vm),
	...
	this->buttons["APPLY"] = new gui::Button(
		gui::p2pX(29.8f, vm), gui::p2pY(74.f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
	...
	this->dropDownLists["RESOLUTION"] = new gui::DropDownList(
		gui::p2pX(40.8f, vm), gui::p2pY(21.2f, vm),
	...
	this->optionsText.setPosition(sf::Vector2f(gui::p2pX(26.8f, vm), gui::p2pY(20.f, vm)));
	this->optionsText.setCharacterSize(gui::calcCharSize(vm, 60));
	this->optionsText.setFillColor(sf::Color(120, 120, 120, 240));
