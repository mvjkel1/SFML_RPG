...
{
	/*
	 * Converts a percentage value to pixels relative to the current resolution int the x-axis.
	 *
...
{
	/*
	 * Converts a percentage value to pixels relative to the current resolution int the y-axis.
	 *
	 * @param	float perc				The percentage value.
	 *
	 * @param	sf::VideoMode&  vm		The current videomode of the window(resolution).
